"""
DCF Excel Sheet 构建函数
========================

包含 DCF 估值工作簿中所有 Sheet 的创建函数以及 finalize_workbook()。
各函数从 dcf_excel_styles 导入样式辅助，从 dcf_core 导入数据计算工具。
"""
...
from afda.dcf_excel_styles import (
    add_legend, add_note, apply_formula_style, apply_header_style,
    apply_input_style, apply_output_style, apply_title_style, set_col_widths,
)
from afda.dcf_core import (
    DCF_INPUT_ITEMS, avg, build_assumption_audit_rows, cagr, clamp,
    coefficient_of_variation, count_positive, dcf_item_usage, get_series,
    load_item_series, load_wide_items, safe_div, trend_slope,
...
def create_summary_sheet(wb: Workbook, data: DCFData) -> None:
    ws = wb.active
    ws.title = "Summary"
...
def create_dcf_input_map_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_readiness_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_wacc_build_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_historical_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_assumptions_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_assumption_audit_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_forecast_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_dcf_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_model_checks_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_scenario_dcf_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_sensitivity_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_comparable_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_investment_thesis_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_charts_sheet(wb: Workbook, data: DCFData) -> None:
...
def create_rawdata_sheet(wb: Workbook, data: DCFData) -> None:
